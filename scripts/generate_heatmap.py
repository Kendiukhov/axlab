...
def generate_heatmap(root_dir, output_path):
                ...
                try:
                    ...
                    if not (degen.get("trivial_identity") or degen.get("projection_collapse") or degen.get("constant_collapse")):
                        ...
                        if props:
                            ...
                            else: val = 3 # Other Law (Lime)
                        else:
                            # Unified Weak Category (User Request: Just make it a shade of gray)
    ...
    # 0: Black, 1: Gray (Trivial), 2: Gold (Unused for now), 3: Lime (Other Laws), 
    # 4: Blue, 5: Cyan, 6: Pink, 7: Purple, 8: Silver (Weak Non-Trivial)
    ...
    ax.legend(patches, labels, loc='upper center', bbox_to_anchor=(0.5, -0.05), ncol=3, frameon=False, labelcolor='white')
